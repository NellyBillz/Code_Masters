...
function ConnectionBadge({ connection }) {
  ...
  return (
    <span
      className={`${styles.badge} ${meta.className || styles.connUnclassified}`}
  ...
  return (
    <span
      className={`${styles.badge} ${
        hasBeginnerFriendlyIssues ? styles.beginnerTrue : styles.beginnerFalse
      }`}
      title={
...
export default function ProjectCard({ project }) {
  ...
  const languageColor = LANGUAGE_COLORS[primaryLanguage] || "#8A897F";
