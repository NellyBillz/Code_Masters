...
// What resolving this report would involve, per its current status — used
// as the label for already-resolved/dismissed reports. Open reports get
// the live AdminReportActions controls (FE-GAP-11) instead of this text.
    ...
    <div className="cm-glass" style={{ borderRadius: "20px", padding: "18px 20px" }}>
      <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: "12px", flexWrap: "wrap" }}>
        ...
        <div style={{ textAlign: "right", flexShrink: 0 }}>
          {report.status === "open" ? (
            <AdminReportActions report={report} onUpdated={onUpdated} />
          ) : (
            <>
